			...
			<div class="elementor-control-input-wrapper elementor-control-unit-5">
				...
				<div style="font-weight: 700; color:#a73061; margin-top: 10px;">
					<# if( data.controlValue != undefined && data.controlValue != '' ) { #>
						<a class="link-cff-builder" href="<?php echo admin_url('admin.php?page=cff-feed-builder') ?>&feed_id={{data.controlValue}}" target="_blank" rel="noopener noreferrer"><?php echo __('Edit this Feed', 'custom-facebook-feed'); ?></a>
						<span style="color:#aaa; display: inline-block; margin: 0 5px;">|</span>
					<# }  #>
					<a href="<?php echo admin_url('admin.php?page=cff-feed-builder') ?>" target="_blank" rel="noopener noreferrer"><?php echo __('Create New Feed', 'custom-facebook-feed'); ?></a>
				</div>
			</div>
		</div>
		<# if ( data.description ) { #>
