        ...
        <div class="cff-fb-source-popup cff-fb-popup-inside" :data-step="viewsActive.sourcePopupScreen" v-if="viewsActive.sourcePopupType != 'customizer'">
            ...
            <div class="cff-fb-source-step4 cff-fb-fs" v-if="viewsActive.sourcePopupScreen == 'step_4'">
                ...
                <div class="sb-two-buttons-wrap">
                    ...
                    <a href="https://smashballoon.com/display-facebook-group-feed/?utm_campaign=facebook-free&utm_source=feed-builder&utm_medium=docs" target="_blank" data-icon="left" class="cff-fb-source-btn cff-fb-fs sb-btn-grey">
