...
namespace FacebookFeed\Vendor\DI\Compiler;

use function chmod;
use FacebookFeed\Vendor\DI\Definition\ArrayDefinition;
use FacebookFeed\Vendor\DI\Definition\DecoratorDefinition;
...
use FacebookFeed\Vendor\DI\Definition\Source\DefinitionSource;
use FacebookFeed\Vendor\DI\Definition\StringDefinition;
use FacebookFeed\Vendor\DI\Definition\ValueDefinition;
use FacebookFeed\Vendor\DI\DependencyException;
use FacebookFeed\Vendor\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use FacebookFeed\Vendor\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
