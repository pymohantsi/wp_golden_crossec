...
namespace FacebookFeed\Vendor\DI\Proxy;

use FacebookFeed\Vendor\ProxyManager\Configuration;
use FacebookFeed\Vendor\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use FacebookFeed\Vendor\ProxyManager\FileLocator\FileLocator;
use FacebookFeed\Vendor\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use FacebookFeed\Vendor\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
